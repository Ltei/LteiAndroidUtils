...
import com.ltei.laugmap.data.geojson.GeoJsonRenderer;
import com.ltei.laugmap.data.kml.KmlContainer;
import com.ltei.laugmap.data.kml.KmlGroundOverlay;
import com.ltei.laugmap.data.kml.KmlRenderer;
 ...
 * {@link com.ltei.laugmap.data.kml.KmlLayer KmlLayer} and
 * {@link com.ltei.laugmap.data.geojson.GeoJsonLayer GeoJsonLayer}
 */
public abstract class Layer {
    ...
    protected boolean hasContainers() {
        return mRenderer instanceof KmlRenderer && ((KmlRenderer) mRenderer).hasNestedContainers();
    }
